        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-9 m-auto">
                    <div class="card">
                        <div class="card-header">Food & Grocery Index Page</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2 m-auto">Grocery Image 1</label>
                                            <div class="col-md-6 m-auto">
                                                <input type="file" class="form-control" name="image1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 m-auto">Bread Image 2</label>
                                            <div class="col-md-6 m-auto">
                                                <input type="file" class="form-control" name="image2">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 m-auto">Fruits & Vegitable Image 3</label>
                                            <div class="col-md-6 m-auto">
                                                <input type="file" class="form-control" name="image3">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 m-auto"> Meat & Fish Image 4</label>
                                            <div class="col-md-6 m-auto">
                                                <input type="file" class="form-control" name="image4">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 m-auto">Fhresh Dairy Image 5</label>
                                            <div class="col-md-6 m-auto">
